...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { age: @voter.age, last_name: @voter.last_name, sex: @voter.sex } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { age: @voter.age, last_name: @voter.last_name, sex: @voter.sex } }
