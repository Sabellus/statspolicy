...
class IntervieweesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interviewee" do
    assert_difference('Interviewee.count') do
      post interviewees_url, params: { interviewee: { age: @interviewee.age, last_name: @interviewee.last_name, sex: @interviewee.sex } }
    end
  ...
  test "should update interviewee" do
    patch interviewee_url(@interviewee), params: { interviewee: { age: @interviewee.age, last_name: @interviewee.last_name, sex: @interviewee.sex } }
